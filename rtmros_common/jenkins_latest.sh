...
cd `rospack find hrpsys`/build/hrpsys-base
ls
# hrpsys
...
echo "!Latest Stable Tag (Tagged by Jenkins). Revision $revision, openhrp3 rev. $openhrp3_revision, hrpsys rev. $hrpsys_revision"
