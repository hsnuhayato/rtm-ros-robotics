...
set(DEBIAN_SOURCE_ORIG_DIR "${CMAKE_BINARY_DIR}/Debian/${CPACK_DEBIAN_PACKAGE_NAME}")
if( CPACK_PACKAGE_VERSION )
set(DEBIAN_SOURCE_ORIG_DIR "${DEBIAN_SOURCE_ORIG_DIR}-${CPACK_PACKAGE_VERSION}")
endif()
...
if( CPACK_PACKAGE_VERSION )
  ...
  execute_process(COMMAND ${CMAKE_COMMAND} -E tar czf "${CPACK_DEBIAN_PACKAGE_NAME}.orig.tar.gz" "${CPACK_DEBIAN_PACKAGE_NAME}.orig" WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/Debian)
endif()
...
foreach(RELEASE ${CPACK_DEBIAN_DISTRIBUTION_RELEASES})
  ...
  set(RELEASE_PACKAGE_VERSION "${CPACK_DEBIAN_DISTRIBUTION_NAME}1~${RELEASE}1")
  if( CPACK_PACKAGE_VERSION )
    set(RELEASE_PACKAGE_VERSION "${CPACK_PACKAGE_VERSION}-${RELEASE_PACKAGE_VERSION}")
  endif()
  ...
  if( CPACK_DEBIAN_PACKAGE_NOSIGN )
    set(DEBUILD_OPTIONS ${DEBUILD_OPTIONS} -i -us -uc)
  endif()
...
if( DPUT_HOST )
  ...
  add_custom_target(dput DEPENDS ${DEB_SOURCE_CHANGES} WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/Debian)
endif()
