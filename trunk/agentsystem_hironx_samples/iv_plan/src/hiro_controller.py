...
class HIROController:
    ...
    def __init__(self, nameserver):
        h_hiroif = get_handle('VisionPC.host_cxt/HiroNXProvider0.rtc', ns)
        # self.motionsvc = h_hiroif.services['HiroNXProvider0.HiroNX'].provided['manipulator']
        self.motionsvc = h_hiroif.services['HiroNXProvider0.HIRO'].provided['motion']
        self.joint_states = zeros(23)
